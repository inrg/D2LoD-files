     D2LoD cd-key viewer by hypnodok
-------------------------------------------------			 
Unzip and place anywhere the folder cdkey_viewer.
Note: you can copy/paste in viewer command window, and can select all text with mouse.
Also you can copy path to your D2LoD from windows explorer's path.
This utility works well for D2LoD 1.13d - 1.14 updated on battle.net
...
Type:
1 C:\ClassicGameD2LoD\Diablo II\           		+Enter

Please enter path to D2 directory eg D:/Games/Diablo II
Or pass it to the executable eg viewer.exe "D:/Games/Diablo II" 
Path to game set to: C:\ClassicGameD2LoD\Diablo II\
Owner: 
Classic Key: 
Xpac Key: 

Type:
2 C:\ClassicGameD2LoD\Diablo II\key1.mpq     	+Enter
...
Path to mpq set to: C:\ClassicGameD2LoD\Diablo II\cdkey1.mpq
Owner: 
Classic Key: 
Xpac Key: 
